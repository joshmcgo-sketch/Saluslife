...
export const PRODUCTS = [
  ...
  },
  {
    ...
    whyPassed:
      'Mushroom supplements are notorious for grain filler sold as extract, so the test is simple: prove it is fruiting body, not mycelium-on-rice, and prove the actives are actually there. Fen & Root discloses a fruiting-body source with a verified beta-glucan percentage and a named farm. It passes, but with the lowest nutrition score — the beta-glucan content is real but modest, and that is stated plainly rather than dressed up.',
    findings: [
